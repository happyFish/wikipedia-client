...
Wikia API reference: "http://en.wikia.org/w/api.php":http://en.wikia.org/w/api.php

Adopted from: "http://code.google.com/p/wikia-client/":http://code.google.com/p/wikia-client/

h2. Installation

<pre><code>gem install wikia-client</code></pre>

h2. Examples

<pre><code>require 'wikia'
...
=> ["http://upload.wikimedia.org/wikia/en/e/e1/Getting_Things_Done.jpg"]

page.image_descriptionurls

=> ["http://en.wikia.org/wiki/File:Getting_Things_Done.jpg"]
...
See the API spec at "http://en.wikia.org/w/api.php":http://en.wikia.org/w/api.php
...
<pre><code>page = Wikia.find( 'Getting Things Done', :prop => "info" )
